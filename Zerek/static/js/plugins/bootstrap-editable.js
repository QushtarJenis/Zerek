...
onDOMContentLoaded(() => {
      ...
      submit: function (e) {
        ...
        try {
          ...
          if ($.type(error) === "object" && error.newValue !== undefined) {
            if (this.options.error_cancel_onempty && !error.msg) {
              return this.cancel();
            }
          ...
          $.when(this.save(submitValue))
            ...
            .fail(
              $.proxy(function (xhr) {
                ...
                if (this.options.error_cancel_onempty && !msg) {
                  return this.cancel();
                }
          ...
          // Notify the user of errors that happen in user defined functions- like dynamic 'pk' functions
  ...
  (function ($) {
    ...
    Popup.prototype = {
      ...
      show: function (closeAll) {
        ...
        if ($tip.is(this.innerCss)) {
          //for inline container
          $tip.append(this.$form);
        } else {
          $tip.find(this.innerCss).append(this.$form);
        }
  ...
  (function ($) {
    ...
    var Editable = function (element, options) {
      ...
      // But do not override name using data-name. If the user specifically defines it- use what they defined; changing the data- field to another value messes up other parts of your code, such as *bootstrap-table-editable.js -> initBody*
      if (options.name) {
  ...
  (function ($) {
    ...
    $.extend(Checklist.prototype, {
      ...
      value2str: function (value) {
        // Account for canceling an inline edit when auto save is enabled
        return (
          ($.isArray(value)
            ? value.sort().join($.trim(this.options.separator))
            : "") ||
          this.sourceData.map(() => "").join($.trim(this.options.separator))
        );
      },
  ...
  (function ($) {
    ...
    $.extend(Constructor.prototype, {
      ...
      getSeparator: function () {
        return (
          this.options.select2.separator || $.fn.select2.defaults.separator
        );
      },
    ...
    $.extend($.fn.editableContainer.Popup.prototype, {
      ...
      initContainer: function () {
        $.extend(this.containerOptions, {
          ...
          selector: false,
          content: " ",
          animation: false, // The popup gets removed from the DOM- which causes issues if it is waiting for the fade to end.
        ...
        this.is_bs5 =
          bootstrap &&
          bootstrap.Popover &&
          bootstrap.Popover.VERSION &&
          bootstrap.Popover.VERSION.startsWith("5");
        if (this.is_bs5) {
      ...
      /* destroy */
      innerDestroy: function () {
        this.call(this.is_bs5 ? "dispose" : "destroy");
      },
      ...
      setPosition: function () {
        if (this.is_bs5) {
          // The new popper library takes care of repositioning
          return;
        }
  ...
  (function ($) {
    ...
    $.extend(Date.prototype, {
      ...
      render: function () {
        ...
        //"clear" link
        if (this.options.clear) {
          this.$clear = $('<a href="javascript:void(0)"></a>')
